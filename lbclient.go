...
func (lc *loadBalancingClient) retry(count int, call func(Client) error) error {
	...
	// All errors returned by client methods are of type `Error`.
	apiErr, ok := err.(*Error)
	if !ok {
		logger.Error("could not cast error into Error")
		return err
	}
...
func (lc *loadBalancingClient) ID(ctx context.Context) (*ID, error) {
	var id *ID
...
func (lc *loadBalancingClient) Peers(ctx context.Context) ([]*ID, error) {
	var peers []*ID
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) PeerJoin(ctx context.Context, addr string) (*ID, error) {
	var id *ID
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) PeerAdd(ctx context.Context, pid peer.ID) (*ID, error) {
	var id *ID
	call := func(c Client) error {
		var err error
...
// human-friendliness.
func (lc *loadBalancingClient) Pin(ctx context.Context, ci cid.Cid, opts PinOptions) (*Pin, error) {
	var pin *Pin
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) Unpin(ctx context.Context, ci cid.Cid) (*Pin, error) {
	var pin *Pin
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) PinPath(ctx context.Context, path string, opts PinOptions) (*Pin, error) {
	var pin *Pin
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) UnpinPath(ctx context.Context, p string) (*Pin, error) {
	var pin *Pin
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) Allocations(ctx context.Context, filter PinType) ([]*Pin, error) {
	var pins []*Pin
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) Allocation(ctx context.Context, ci cid.Cid) (*Pin, error) {
	var pin *Pin
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) Status(ctx context.Context, ci cid.Cid, local bool) (*GlobalPinInfo, error) {
...
func (lc *loadBalancingClient) StatusAll(ctx context.Context, filter TrackerStatus, local bool) ([]*GlobalPinInfo, error) {
...
func (lc *loadBalancingClient) Sync(ctx context.Context, ci cid.Cid, local bool) (*GlobalPinInfo, error) {
	var pinInfo *GlobalPinInfo
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) SyncAll(ctx context.Context, local bool) ([]*GlobalPinInfo, error) {
	var pinInfos []*GlobalPinInfo
	call := func(c Client) error {
		var err error
...
// it happens on every cluster peer.
func (lc *loadBalancingClient) Recover(ctx context.Context, ci cid.Cid, local bool) (*GlobalPinInfo, error) {
	var pinInfo *GlobalPinInfo
	call := func(c Client) error {
		var err error
...
// everywhere.
func (lc *loadBalancingClient) RecoverAll(ctx context.Context, local bool) ([]*GlobalPinInfo, error) {
	var pinInfos []*GlobalPinInfo
	call := func(c Client) error {
		var err error
...
func (lc *loadBalancingClient) Version(ctx context.Context) (*Version, error) {
	var v *Version
	call := func(c Client) error {
		var err error
		v, err = c.Version(ctx)
...
func (lc *loadBalancingClient) GetConnectGraph(ctx context.Context) (*ConnectGraph, error) {
...
func (lc *loadBalancingClient) Metrics(ctx context.Context, name string) ([]*Metric, error) {
	var metrics []*Metric
	call := func(c Client) error {
		var err error
